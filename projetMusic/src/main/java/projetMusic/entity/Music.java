...
@NamedQueries({
		...
		// Selection de toutes les musiques (et leurs albums et artistes) nommées comme
		// l'input
		...
		// Selection de toutes les musiques (et leurs albums) qui ont un album nommé
		// comme l'input
